...
documents = [
    ...
    Document(page_content="MMR (Maximal Marginal Relevance) is a technique for diverse information retrieval."),
    Document(page_content="langchain-core is a foundational library for building LLM applications."),
]
...
retriever = vector_store.as_retriever(
    ...
    search_kwargs={"k": 2 , "lambda_mult": 0.5}  # Retrieve top 2 results
