...
# 5. Create an MMRRetriever from the vector store
mmr_retriever = MMRRetriever(vectorstore=vectorstore)

# 6. Retrieve diverse documents for a query
query = "Tell me about Paris and Berlin."
