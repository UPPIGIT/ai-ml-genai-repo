"""
Application Log Issues List Parser Example (with Gemini and CommaSeparatedListOutputParser)
This example demonstrates how to use LangChain's CommaSeparatedListOutputParser to extract a list of issues from logs.
"""
...
prompt = PromptTemplate.from_template(
    """Read the following application logs and list all issues or anomalies as a comma-separated list.
